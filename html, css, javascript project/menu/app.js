...
function displayMenuButtons(){
    ...
    // render the unique category buttons in the page
    ...
    // render the page according to the buttton that is clicked
    filterBtns.forEach(function(btn){
        btn.addEventListener("click", function(e){
            const menuCatetgory = menu.filter(function(menuItem){
            ...
            if(category === "all"){
                ...
                displayMenuItems(menuCatetgory)
            }
        })
    })
}